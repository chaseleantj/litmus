...
You use Litmus in a few simple steps. First, you paste in a text and get a score, or paste two and see which one sounds more like you. Then you manage the AI/human pairs the score is learned from. You need at least 2 pairs. Finally, you can plot your whole library on a 2D map.
